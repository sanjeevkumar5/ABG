...
/* /**
 * '#############################################################################################################################
 * '## SCRIPT NAME: BUDGET_GUI_CreateRentals '## BRAND: BUDGET '## DESCRIPTION:
...
public class Budget_GUI_CreateRentals
{
	...
	public void test() throws Exception 
	{
		...
		try {
			...
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\Selenium\\Test_Data\\BUDGET\\BUDGET_GUITestData_Rental_CheckOut.xlsx");
	...
	//	public static void main(String[] args) throws IOException, Exception, FileNotFoundException 
		...
		for (int k = 1; k <=intRowCount; k++)
		{
			...
			String Execute = rwe.getCellData("Budget_GUI_Rentals", k, 2);
			if (Execute.equals("Y"))
			{
				...
				System.out.println(" iteration " + k);
				 String btestcasename 	= rwe.getCellData("Budget_GUI_Rentals", k, 4);
				 String bclientURL   	= rwe.getCellData("Budget_GUI_Rentals", k, 7);
				 String boutSTA      	= rwe.getCellData("Budget_GUI_Rentals", k, 10);
				 String bthinClient  	= bclientURL+boutSTA;
				 String buName       	= rwe.getCellData("Budget_GUI_Rentals", k, 8);
				 String bpswd        	= rwe.getCellData("Budget_GUI_Rentals", k, 9);
				 String bResNo      	= rwe.getCellData("Budget_GUI_Rentals", k, 11);
				 String bCustType		= rwe.getCellData("Budget_GUI_Rentals", k, 12);
				 String bWizardNo		= rwe.getCellData("Budget_GUI_Rentals", k, 13);
				 String bLastName		= rwe.getCellData("Budget_GUI_Rentals", k, 14);
				 String bFirstName		= rwe.getCellData("Budget_GUI_Rentals", k, 15);
				 String bCOCountry 		= rwe.getCellData("Budget_GUI_Rentals", k, 16);
				 String bCOState		= rwe.getCellData("Budget_GUI_Rentals", k, 17);
				 String bCODRLICNO 		= rwe.getCellData("Budget_GUI_Rentals", k, 18);
				 String bCODOB			= rwe.getCellData("Budget_GUI_Rentals", k, 19);
				 String bCOCOMPANY		= rwe.getCellData("Budget_GUI_Rentals", k, 20);
				 String bCOADDR1		= rwe.getCellData("Budget_GUI_Rentals", k, 21);
				 String bCOADDR2		= rwe.getCellData("Budget_GUI_Rentals", k, 22);
				 String bCOADDR3		= rwe.getCellData("Budget_GUI_Rentals", k, 23);
				 String bCOCONTACTINFO  = rwe.getCellData("Budget_GUI_Rentals", k, 24);
				 String bCOEMAIL		= rwe.getCellData("Budget_GUI_Rentals", k, 25);
				 String bCOMOP			= rwe.getCellData("Budget_GUI_Rentals", k, 26);
				 String bCOCCDC			= rwe.getCellData("Budget_GUI_Rentals", k, 27);
				 String bCARDNO			= rwe.getCellData("Budget_GUI_Rentals", k, 28);
				 String bCOMM			= rwe.getCellData("Budget_GUI_Rentals", k, 29);
				 String bCOYY			= rwe.getCellData("Budget_GUI_Rentals", k, 30);
				 String bMOPREASON		= rwe.getCellData("Budget_GUI_Rentals", k, 31);
				 String bRETURNSTATION	= rwe.getCellData("Budget_GUI_Rentals", k, 32);
				 String bRETURNDATE		= rwe.getCellData("Budget_GUI_Rentals", k, 33);
				 String bRETURNTIME		= rwe.getCellData("Budget_GUI_Rentals", k, 34);
				 String bCARGROUP		= rwe.getCellData("Budget_GUI_Rentals", k, 35);
				 String bAWD			= rwe.getCellData("Budget_GUI_Rentals", k, 36);
				 String bCOUPON			= rwe.getCellData("Budget_GUI_Rentals", k, 37);
				 String bFTNTYPE		= rwe.getCellData("Budget_GUI_Rentals", k, 38);
				 String bFTNUMBER		= rwe.getCellData("Budget_GUI_Rentals", k, 39);
				 String bREMARKS		= rwe.getCellData("Budget_GUI_Rentals", k, 40);
				 String bCOMVA			= rwe.getCellData("Budget_GUI_Rentals", k, 41);
				 String bCOMILEAGE		= rwe.getCellData("Budget_GUI_Rentals", k, 42);
				 String bINSURANCE		= rwe.getCellData("Budget_GUI_Rentals", k, 43);
				 String bCOUNTERPRODUCT	= rwe.getCellData("Budget_GUI_Rentals", k, 44);
				 String bADRLASTNAME	= rwe.getCellData("Budget_GUI_Rentals", k, 45);
				 String bADRFIRSTNAME	= rwe.getCellData("Budget_GUI_Rentals", k, 46);
				 String bADRDOB			= rwe.getCellData("Budget_GUI_Rentals", k, 47);
				 String bADRCOUNTRY		= rwe.getCellData("Budget_GUI_Rentals", k, 48);
				 String bADRSTATE		= rwe.getCellData("Budget_GUI_Rentals", k, 49);
				 String bADRDRLICNO		= rwe.getCellData("Budget_GUI_Rentals", k, 50);
				 String bADREXPMM		= rwe.getCellData("Budget_GUI_Rentals", k, 51);
				 String bADREXPYY		= rwe.getCellData("Budget_GUI_Rentals", k, 52);
				 String bADRADDR1		= rwe.getCellData("Budget_GUI_Rentals", k, 53);
				 String bADRADDR2		= rwe.getCellData("Budget_GUI_Rentals", k, 54);
				 String bADRADDR3		= rwe.getCellData("Budget_GUI_Rentals", k, 55);
				 String bADRTELEPHONE1	= rwe.getCellData("Budget_GUI_Rentals", k, 56);
				 String bADRTELEPHONE2  = rwe.getCellData("Budget_GUI_Rentals", k, 57);
				 String bADRCCDC		= rwe.getCellData("Budget_GUI_Rentals", k, 58);
				 String bADRCARDNO		= rwe.getCellData("Budget_GUI_Rentals", k, 59);
				 String bADRCCEXPMM		= rwe.getCellData("Budget_GUI_Rentals", k, 60);
				 String bADRCCEXPYY		= rwe.getCellData("Budget_GUI_Rentals", k, 61);
				 ...
				 driver.findElement(By.xpath("//input[@id='searchString']")).sendKeys(bResNo);
				...
				// driver.findElement(By.xpath("//input[@id='glyphicon glyphicon-plus']")).click();
				 ...
				 if (year.isEmpty())
				 {
					...
					rwe.setCellData("Budget_GUI_Rentals", k, 62,RateCode);
					...
					rwe.setCellData("Budget_GUI_Rentals", k, 70, OptMSG);
					rwe.setCellData("Budget_GUI_Rentals", k, 71, "FAIL");
					test.log(Status.FAIL, "Fail");
					String ScreenShotPath = "C:\\Selenium\\Screenshots\\Budget\\Budget_Create_Rentals\\";
				 ...
				 // Checkout complete Screen and update in Excel 
					  ...
					  //tring screenname = driver.findElement(By.xpath("//h5[@class='completeCheckout ng-binding']")).getText();
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 63, strCOLNFNGetText);
		              ...
		              // String strCOVehicleModelGetText = driver.findElement(By.id("checkoutDialog:checkoutCompleteForm:checkoutCompleteVehicle")).getText();
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 64, strCOVehicleModelGetText);
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 65, strCOResNoGetText);
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 66, strCOMVAGetText);
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 67, strCORANoGetText);
		              ...
		              // String strCOLicensePlateNoGetText = driver.findElement(By.id("checkoutDialog:checkoutCompleteForm:checkoutCompleteLicensePlate")).getText();
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 68, strCOLicensePlateNoGetText);
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 69, strCOEstimatedCostGetText);
		               ...
		               Thread.sleep(7000);
		               rwe.setCellData("Budget_GUI_Rentals", k, 70, strCOSystemMsgGetText);
					...
					String ScreenShotPath2 = "C:\\Selenium\\Screenshots\\Budget\\Budget_Create_Rentals\\";
                    ...
                    if(rwe.getCellData("Budget_GUI_Rentals", k, 64).isEmpty())
                    {
						rwe.setCellData("Budget_GUI_Rentals", k, 71,"FAIL");
				test.log(Status.FAIL, "Fail");
					} else {
						rwe.setCellData("Budget_GUI_Rentals", k, 71, "PASS");
