...
/**
'#############################################################################################################################
'## SCRIPT NAME:                           GUI_Manifest_Budget
'## BRAND:                                         Budget
...
public class BUDGET_GUI_Manifest {

	public static void main(String[] args) throws Throwable {
		
		for (int k=1; k<=6; k++)
		{
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\Backup\\ABG SE Scripts\\TestData\\Manifest\\BUD_GUITestData_Manifest_Regression.xlsx");
