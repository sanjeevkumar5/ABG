/**
'#############################################################################################################################
'## SCRIPT NAME:                           AVIS_GUI_ReadyLine_Regression
'## BRAND:                                 AVIS
...
public class AVIS_GUI_ReadyLine_Regression
{
	...
	public void test() throws Exception //TestNG Extent Reports Changes.
	{
	   try //TestNG Extent Reports Changes.
	   {
	     ...
	     AVIS.CommonFunctions.ReadWriteExcel rwe  = new ReadWriteExcel("C:\\GitHub\\ABG\\AVIS\\TestData\\InternetGUI\\AVIS_GUITestData_ReadyLine_Regression.xlsx");
		 ...
		 for (int k=1;k<=60;k++)
	     {
		    //ReadWriteExcel rwe  = new ReadWriteExcel("C:\\GitHub\\ABG\\AVIS\\TestData\\InternetGUI\\AVIS_GUITestData_ReadyLine_Regression.xlsx",intRowCount);
		    //System.out.println(" total row count in ReadyLine test data sheet is : " + intRowCount);
...
/*     	      String strMVA1        = rwe.getCellData("INPUT_DATA", k, 12);
	        ...
	        //{
			  ...
			  if (rwe.getCellData("INPUT_DATA", k, 74).isEmpty())
			  {
				 ...
				 test.log(Status.INFO, " Ready line reports are available for Readyline " + strOption);  //TestNG Extent Reports Changes.
				 test.pass("Screenshot below : " + test.addScreenCaptureFromPath(takeScreenShot("UserName_Field"))); //TestNG Extent Reports Changes.
			  ...
			  else
			  {
				 ...
				 test.log(Status.PASS, "Pass"); //TestNG Extent Reports Changes.
				 test.log(Status.INFO, " Ready line reports are available for Readyline " + strOption);  //TestNG Extent Reports Changes.
				 //test.fail("Screenshot below: " + test.addScreenCaptureFromPath(takeScreenShot("UserName_Field"))); //TestNG Extent Reports Changes.
				 test.pass("Screenshot below : " + test.addScreenCaptureFromPath(takeScreenShot("UserName_Field"))); //TestNG Extent Reports Changes.
		         String ScreenShotPath  = "C:\\Selenium\\Workspace\\ABG_GUI_Automation\\ScreenShots\\";
		         File file = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		         //FileUtils.copyFile(file,new File( ScreenShotPath+strTestCaseName+ ".jpg"));
	     ...
	     AVIS_GUI_ReadyLine_Regression Avis = new AVIS_GUI_ReadyLine_Regression();
   ...
   private String takeScreenShot(String string)
   {
...
} // End of AVIS_GUI_ReadyLine_Regression Class.