...
public class Avis_GUI_VoidRental
{
	...
	public void test() throws Exception {
		...
		for (int k = 1; k <= 65; k++)
		{
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\GUI_Automation\\Selenium\\GUI_TestDataSheets\\AVIS_GUITestData_VoidRental.xlsx");
			String Execute = rwe.getCellData("AVIS_VOIDRENTAL", k, 2);
			...
			if (Execute.equals("Y"))
			{
				...
				System.out.println(" iteration " + k);
				String testCaseName= rwe.getCellData("AVIS_VOIDRENTAL", k, 5);
				String clientURL   = rwe.getCellData("AVIS_VOIDRENTAL", k, 6);
				String outSTA      = rwe.getCellData("AVIS_VOIDRENTAL", k, 7);
				String thinClient  = clientURL+outSTA;
				String uName       = rwe.getCellData("AVIS_VOIDRENTAL", k, 8);
				String pswd        = rwe.getCellData("AVIS_VOIDRENTAL", k, 9);
				String RANo        = rwe.getCellData("AVIS_VOIDRENTAL", k, 10);
				String voidRemarks = rwe.getCellData("AVIS_VOIDRENTAL", k, 11);
				...
				try	
				{
				    ...
				    Thread.sleep(3000);
					rwe.setCellData("AVIS_VOIDRENTAL", k, 16, alertMsg);
				...
				{	
					...
					if(RAStatus.equalsIgnoreCase("Open Rental"))
					{
						...
						rwe.setCellData("AVIS_VOIDRENTAL", k, 12, db_VoidSuccessDialog);
						rwe.setCellData("AVIS_VOIDRENTAL", k, 13, db_VoidRenterName);
						rwe.setCellData("AVIS_VOIDRENTAL", k, 14, db_VoidRA);
						rwe.setCellData("AVIS_VOIDRENTAL", k, 15, db_VoidSuccessOutMsg);
					...
					{
						rwe.setCellData("AVIS_VOIDRENTAL", k, 16, RAStatus);
