package manifest;
	...
	//	public static void main(String[] args) throws Madhu@123Throwable {
		...
		public void test() throws Exception
		{
			try
			{
			   ...
			   for (int k=1; k<=2; k++)
			   {
				   ReadWriteExcel rwe = new ReadWriteExcel("C:\\GUI_Testing\\TestData\\Manifest\\Avis_GUITestData_Manifest_Regression.xlsx");
				   ...
				   String ScreenShotPath = "C:\\GUI_Testing\\ScreenShot\\Avis\\Manifest\\";
				   ...
				   String USERID 					= rwe.getCellData("Manifest_Avis", k,  8);
				   String PASSWORD 					= rwe.getCellData("Manifest_Avis", k,  9);
				   String OUTSTATION				= rwe.getCellData("Manifest_Avis", k,  10);
	//			   String COUNTER_NUM				= rwe.getCellData("Manifest_Avis", k, 13);
				...
				if (Execute.equals("Y"))
				{
					...
					String OneDay_LOR = rwe.getCellData("Manifest_Avis", k, 12);
					...
					String DetailType = rwe.getCellData("Manifest_Avis", k, 11);
		...
		// Logout the application when the "No reservations found"
					...
					else
					{
					    ...
					    rwe.setCellData("Manifest_Avis", k, 15, str);
						Thread.sleep(2000);
		...
		//		Thread.sleep(2000);
						rwe.setCellData("Manifest_Avis", k, 16, ResNo1);
						...
						rwe.setCellData("Manifest_Avis", k, 18, AWD1);
						...
						rwe.setCellData("Manifest_Avis", k, 19, Wizard1);
						...
						rwe.setCellData("Manifest_Avis", k, 47, Coupon1);
						...
						rwe.setCellData("Manifest_Avis", k, 20, PickUpLoc1);
						...
						rwe.setCellData("Manifest_Avis", k, 21, PickupDate1);
						...
						rwe.setCellData("Manifest_Avis", k, 22, ReturnLoc1);
						...
						rwe.setCellData("Manifest_Avis", k, 23, ReturnDateTime1);
						...
						rwe.setCellData("Manifest_Avis", k, 24, CarClass1);
						...
						rwe.setCellData("Manifest_Avis", k, 25, BookingDt1);
						Thread.sleep(2000);
		...
		// Max days (2 days)of Manifest
						...
						String TwoDay_LOR = rwe.getCellData("Manifest_Avis", k, 13);
		...
		//Capture the total number of items are displayed		
						...
						rwe.setCellData("Manifest_Avis", k, 26, max_str);
		...
		//Select a one of the record to open in report format		
						...
						rwe.setCellData("Manifest_Avis", k, 27, max_ResNo1);
						...
						rwe.setCellData("Manifest_Avis", k, 29, max_AWD1);
						...
						rwe.setCellData("Manifest_Avis", k, 30, max_Wizard1);
						...
						rwe.setCellData("Manifest_Avis", k, 31, max_PickUpLoc1);
						...
						rwe.setCellData("Manifest_Avis", k, 32, max_PickupDate1);
						...
						rwe.setCellData("Manifest_Avis", k, 33, max_ReturnLoc1);
						...
						rwe.setCellData("Manifest_Avis", k, 34, max_ReturnDateTime1);
						...
						rwe.setCellData("Manifest_Avis", k, 35, max_CarClass1);
						...
						rwe.setCellData("Manifest_Avis", k, 36, max_BookingDt1);
						Thread.sleep(2000);
		// Pass/Fail Status
						...
						rwe.setCellData("Manifest_Avis", k, 37, max_ResDetails);
						Thread.sleep(3000);
		...
		// Capture the screen shot of the report
						...
						if (rwe.getCellData("Manifest_Avis", k, 37).isEmpty())
						{
							rwe.setCellData("Manifest_Avis", k, 38, "FAIL");
							test.log(Status.FAIL, "Fail");
						}
						else
						{
							test.log(Status.PASS, "Pass");
							rwe.setCellData("Manifest_Avis", k, 38, "PASS");
						}
