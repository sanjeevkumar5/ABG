...
public class Budget_GUI_VoidRental
{
...
//	public static void main(String[] args) throws IOException, Exception, FileNotFoundException, InterruptedException  
	...
	public void test() throws Exception
	{
		...
		for (int k = 1; k <= 20; k++)
		{
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\GUI_Automation\\Selenium\\GUI_TestDataSheets\\Budget_GUITestData_VoidRental.xlsx");
			String Execute = rwe.getCellData("BUDGET_VOIDRENTAL", k, 2);
			...
			if (Execute.equals("Y"))
			{
				...
				System.out.println(" iteration " + k);
				String testCaseName   = rwe.getCellData("BUDGET_VOIDRENTAL", k, 5);
				String clientURL   = rwe.getCellData("BUDGET_VOIDRENTAL", k, 6);
				String outSTA      = rwe.getCellData("BUDGET_VOIDRENTAL", k, 7);
				String thinClient  = clientURL+outSTA;
				String uName       = rwe.getCellData("BUDGET_VOIDRENTAL", k, 8);
				String pswd        = rwe.getCellData("BUDGET_VOIDRENTAL", k, 9);
				String RANo        = rwe.getCellData("BUDGET_VOIDRENTAL", k, 10);
				String voidRemarks = rwe.getCellData("BUDGET_VOIDRENTAL", k, 11);
				...
				try
				{
				    ...
				    Thread.sleep(3000);
					rwe.setCellData("BUDGET_VOIDRENTAL", k, 16, alertMsg);
				...
				{	
					...
					if(RAStatus.equalsIgnoreCase("Open Rental"))
					{
						...
						rwe.setCellData("BUDGET_VOIDRENTAL", k, 12, db_VoidSuccessDialog);
						rwe.setCellData("BUDGET_VOIDRENTAL", k, 13, db_VoidRenterName);
						rwe.setCellData("BUDGET_VOIDRENTAL", k, 14, db_VoidRA);
						rwe.setCellData("BUDGET_VOIDRENTAL", k, 15, db_VoidSuccessOutMsg);
					...
					{
						rwe.setCellData("BUDGET_VOIDRENTAL", k, 16, RAStatus);
