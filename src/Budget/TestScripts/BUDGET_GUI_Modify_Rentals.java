...
/**
* '#############################################################################################################################
* '## SCRIPT NAME: BUDGET_GUI_Modify_Rentals 
* '## BRAND: BUDGET 
...
public class BUDGET_GUI_Modify_Rentals {
	...
	public void test() throws Exception {
		...
		for (int k = 1; k <= 100; k++)
		{
			BUDGET_GUI_Modify_Rentals avis = new BUDGET_GUI_Modify_Rentals();
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\Users\\cmn\\Desktop\\Selenium\\TestData\\BUDGET_GUITestData_DisplayModifyRental.xlsx");
			String Execute = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 2);
			...
			if (Execute.equals("Y"))
			{
				...
				String testcasename    = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 4);
				String tokenURL    	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 6);
				String clientURL       = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 7);
				String outSTA          = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 8);
				String thinClient      = clientURL+outSTA;
				String uName           = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 9);
				String pswd            = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 10);
				String Rano            = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 11);
				String Custcoun		   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 12);
				String Custstate	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 13);
				String CustLicno	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 14);
				String CustDOB		   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 15);
				String Custcompy	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 16);
				String CustAddr1	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 17);
				String CustAddr2	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 18);
				String CustAddr3	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 19);
				String Custcontno	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 20);
				String Custemail	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 21);
				String CustFtntype	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 22);
				String CustFtnno	   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 23);
				String Vehiclemilageout	= rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 24);
				String Vehicleinfospace	= rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 25);
				String Vehicleinfofuelsvc= rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 26);
				String Vehicleinfofuellvl= rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 27);
				String Vehicleinfodamaged= rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 28);
				String Vehicleinfoaccrept= rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 29);
				String Reninfocodte		 = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 30);
				String Reninfocotme      = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 31);
				String Reninfoawd        = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 32);
				String Reninfocpn	     = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 33);
				String Reninfortnstation = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 34);
				String Reninfortndate    = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 35);
				String Reninfortntime    = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 36);
				String Reninfodelivery   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 37);
				String Reninforatecode   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 38);
				String Reninforemarks    = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 39);
				String Reninfonewayfee   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 40);
				String Reninforemchkbx   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 41);
				String Reninfocomissio   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 42);
				String Reninfotax        = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 43);
				String Reninfodiscount   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 44);
				String Reninfomancalamt   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 45);
				String Reninfomancalamtdrpdwn   = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 46);
				String Paymentinfomop     = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 47);
				String Paymentinfoccdc     = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 48);
				String Paymentinfocardno     = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 49);
				String Paymentinfomm     = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 50);
				String Paymentinfoyy     = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 51);
				String Paymentinfomoprsn    = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 52);
				String AdjCustsercer = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 53);
				String AdjCustmoneyoff = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 54);
				String AdjCustbreakdown = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 55);
				String AdjCustseccpn = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 56);
				String AdjCustdamproperty = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 57);
				String AdjCustfuel = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 58);
				String AdjCustfuelamount = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 59);
				String AdjCustothreason = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 60);
				String AdjCustothamount = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 61);
				String Misparking = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 62);
				String Mishandling = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 63);
				String Misaccrep = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 64);
				String Misluggage = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 65);
				String Misphoneacc = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 66);
				String Miswheeldam = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 67);
				String Miscleaningmain = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 68);
				String Misparkingfines = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 69);
				String Mispickupfees = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 70);
				String Mispickuptowing = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 71);
				String Misothers = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 72);
				String Misoneway = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 73);
				String ProtsCovagesInsur = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 74);
				String Counterprd = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 75);
				String Messagetype = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 76);
				String Messagebox = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 77);
				...
				**/
				...
				if (ProtsCovagesInsur.isEmpty()) {
					...
					String[] Insurancevalue = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 74).split("-");
			...
			/**
			 //Modifying message and saving the same
				...
				{
					String[] Message = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 76).split("-");
				...
				if (Counterprd.isEmpty()) {
					...
					String[] CPvalue = rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 75).split("-");
                              ...
                              if (val.isEmpty()) {
                                     ...
                                     if (j == 2) {
                                    	 if(a1<=99)
                                    	 {
                                            ...
                                            rwe.setCellData("BUDGET_GUI_Modify_Rentals", k, a1, val);
                                            a1++;
                                    	 }
                                     }
                              }
			...
			//div[@id='QuickView-qvDisplayRental']//div[@class='panel-body']
				...
				//taking screenshot
				String ScreenShotPath = "C:\\Users\\cmn\\Desktop\\Selenium\\Screenshots\\BUDGET_GUITestData_DisplayModifyRental\\";
				...
				if (rwe.getCellData("BUDGET_GUI_Modify_Rentals", k, 79).isEmpty()) {
					
					rwe.setCellData("BUDGET_GUI_Modify_Rentals", k, 100, "FAIL");
					test.log(Status.FAIL, "Fail");
				} else {
					rwe.setCellData("BUDGET_GUI_Modify_Rentals", k, 100, "PASS");
