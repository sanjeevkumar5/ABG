/**
'#############################################################################################################################
'## SCRIPT NAME     : Budget_GUI_Split_Billing_CheckOut
'## BRAND           : Budget
   ...
   //public static void main(String[] args) throws IOException, Exception, FileNotFoundException
	...
	public void test() throws Exception //TestNG Extent Reports Changes.
	{
	   try //TestNG Extent Reports Changes.
	   {
	      ...
	      ReadWriteExcel rwe  = new ReadWriteExcel("C:\\GitHub\\ABG\\Budget\\TestData\\InternetGUI\\Budget_GUI_Split_Billing_CheckOut.xlsx");
	      ...
	      { 
		     ...
		     if (Execute.equals("Y"))
             {
	          ...
	          Budget_GUI_Split_Billing_CheckOut Avis = new Budget_GUI_Split_Billing_CheckOut();              
