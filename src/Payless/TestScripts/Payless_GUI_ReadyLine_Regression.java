/**
'#############################################################################################################################
'## SCRIPT NAME:                           Payless_GUI_ReadyLine_Regression
'## BRAND:                                 Payless
...
public class Payless_GUI_ReadyLine_Regression
{
	...
	public void test() throws Exception //TestNG Extent Reports Changes.
	{
	   try //TestNG Extent Reports Changes.
	   {
	     ...
	     ReadWriteExcel rwe  = new ReadWriteExcel("C:\\GitHub\\ABG\\Payless\\TestData\\InternetGUI\\Payless_GUITestData_ReadyLine_Regression.xlsx");
         
	     int intRowCount = rwe.sheet.getLastRowNum();
...
/*     	      String strMVA1        = rwe.getCellData("INPUT_DATA", k, 12);
	     ...
	     Payless_GUI_ReadyLine_Regression Avis = new Payless_GUI_ReadyLine_Regression();
...
} // End of Payless_GUI_ReadyLine_Regression Class.