package checkIn_SB;
	...
	/**
	'#################################################################################################################################
	'## SCRIPT NAME:                           PAYLESS_GUI_CheckIn with Split Billing
	'## BRAND:                                         PAYLESS
	'## DESCRIPTION:                           Perform a CheckIn of Rental in different regions for Payless.
	...
	public class Payless_checkIn_SB {
	...
	//	public static void main(String[] args) throws Throwable {
		...
		public void test() throws Exception
		{
			try
			{
			   ...
			   for (int K=1; K<=5; K++)
			   {
					...
					ReadWriteExcel rwe = new ReadWriteExcel("C:\\GUI_Testing\\TestData\\CheckIn\\PAYLESS_GUITestData_CheckIn.xlsx");
					...
					String ScreenShotPath = "C:\\GUI_Testing\\ScreenShot\\Payless\\CheckIn\\";
					
					String Execute 			= rwe.getCellData("CheckIn_Payless", K,  1);
					String TESTCASENAME		= rwe.getCellData("CheckIn_Payless", K,  3);
					String THINCLIENTURL	= rwe.getCellData("CheckIn_Payless", K,  5);
					String Region			= rwe.getCellData("CheckIn_Payless", K,  6);
					String USERID 			= rwe.getCellData("CheckIn_Payless", K,  7);
					String PASSWORD 		= rwe.getCellData("CheckIn_Payless", K,  8);
					String RANO				= rwe.getCellData("CheckIn_Payless", K,  9);
					String MOP				= rwe.getCellData("CheckIn_Payless", K, 10);
					String CARDTYPE			= rwe.getCellData("CheckIn_Payless", K, 11);
					String CARDNO			= rwe.getCellData("CheckIn_Payless", K, 12);
					String EXPMONTH			= rwe.getCellData("CheckIn_Payless", K, 13);
					String EXPYEAR			= rwe.getCellData("CheckIn_Payless", K, 14);
					String CKECKINOUT_AUTH	= rwe.getCellData("CheckIn_Payless", K, 15);
					String ADDR1			= rwe.getCellData("CheckIn_Payless", K, 16);
					String ADDR3			= rwe.getCellData("CheckIn_Payless", K, 17);
					String SBTYPE			= rwe.getCellData("CheckIn_Payless", K, 18);
					...
					//Enter the values in SB screen
						...
						{	
							...
							System.out.println(TESTCASENAME);
								...
								rwe.setCellData("CheckIn_Payless", K, 21, "Dollar Amount and number of Days values are not displayed");
								rwe.setCellData("CheckIn_Payless", K, 22, "FAIL");
						...
						rwe.setCellData("CheckIn_Payless", K, 19, TotLorVal);
						...
						rwe.setCellData("CheckIn_Payless", K, 20, TotBillVal);
						...
						if (Error.isDisplayed())
						{
						    ...
						    {
								rwe.setCellData("CheckIn_Payless", K, 21, "Error Code: -1 displayed");
								rwe.setCellData("CheckIn_Payless", K, 22, "FAIL");
								test.log(Status.FAIL, "Fail");
		...
		//					WebElement strInvalidCard = driver.findElement(By.id("checkinRepromptDialog:checkInRepromptForm:repromptOut"));
					...
					//Complete Check In
							...
							if (CompCheckIn.isDisplayed());
							{
							    ...
							    if (getCheckInText.contains("Complete Check In"))
							    {
									...
									rwe.setCellData("CheckIn_Payless", K, 21, CCI);
					...
					// Logout the application
							...
							if (rwe.getCellData("CheckIn_Payless", K, 21).isEmpty())
							{
								rwe.setCellData("CheckIn_Payless", K, 22, "FAIL");
								test.log(Status.FAIL, "Fail");
							}
							else
							{
								...
								rwe.setCellData("CheckIn_Payless", K, 22, "PASS");
							}
