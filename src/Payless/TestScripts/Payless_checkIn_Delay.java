...
public class Payless_checkIn_Delay {
		...
		public void test() throws Exception
		{
			try
			{
			   ...
			   for (int K=1; K<=2; K++)
			   {
					...
					ReadWriteExcel rwe 		= new ReadWriteExcel("C:\\GUI_Testing\\TestData\\DelayedCheckIn\\PAYLESS_GUITestData_DelayedCheckIn.xlsx");
					...
					String ScreenShotPath 	= "C:\\GUI_Testing\\ScreenShot\\Payless\\DelayedCheckIn\\";
					
					String Execute 			= rwe.getCellData("DelayedCheckIn_Payless", K,  1);
					String ENVIRONMENT 		= rwe.getCellData("DelayedCheckIn_Payless", K,  2);
					String TESTCASENAME		= rwe.getCellData("DelayedCheckIn_Payless", K,  3);
					String THINCLIENTURL	= rwe.getCellData("DelayedCheckIn_Payless", K,  5);
					String Region			= rwe.getCellData("DelayedCheckIn_Payless", K,  6);
					String USERID 			= rwe.getCellData("DelayedCheckIn_Payless", K,  7);
					String PASSWORD 		= rwe.getCellData("DelayedCheckIn_Payless", K,  8);
					String RANO				= rwe.getCellData("DelayedCheckIn_Payless", K,  9);
					String RETURNDATE		= rwe.getCellData("DelayedCheckIn_Payless", K, 10);
					String RETURNTIME		= rwe.getCellData("DelayedCheckIn_Payless", K, 11);
...
//							FileUtils.copyFile(src1,new File( ScreenShotPath +TESTCASENAME+ sdf1.format(d1)+"_Print"+".pgn"));
					...
					//Complete Check In
						...
						if (CompCheckIn.isDisplayed());
						{
						    ...
						    if (getCheckInText.contains("Complete Check In"))
						    {
								...
								rwe.setCellData("DelayedCheckIn_Payless", K, 12, CCI);
					...
					if (rwe.getCellData("DelayedCheckIn_Payless", K, 12).isEmpty())
					{
						rwe.setCellData("DelayedCheckIn_Payless", K, 13, "FAIL");
						test.log(Status.FAIL, "Fail");
					}
					else
					{
						test.log(Status.PASS, "Pass");
						rwe.setCellData("DelayedCheckIn_Payless", K, 13, "PASS");
					}
