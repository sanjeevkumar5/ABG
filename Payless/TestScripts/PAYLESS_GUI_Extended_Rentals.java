...
/**
 * '#############################################################################################################################
 * '## SCRIPT NAME: BUDGET_GUI_Extended_Rentals '## BRAND: AVIS '## DESCRIPTION:
...
public class PAYLESS_GUI_Extended_Rentals {
	...
	public void test() throws Exception {
		try {
			...
			for (int k = 1; k <= 100; k++) {
				PAYLESS_GUI_Extended_Rentals avis = new PAYLESS_GUI_Extended_Rentals();
				ReadWriteExcel rwe = new ReadWriteExcel(
						"C:\\Users\\cmn\\Desktop\\Selenium\\TestData\\BUDGET_GUITestData_Extended_Rental.xlsx");
				String Execute = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 2);
				...
				if (Execute.equals("Y")) {
					...
					String testcasename = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 4);
					String tokenURL = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 6);
					String clientURL = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 7);
					String outSTA = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 8);
					String thinClient = clientURL + outSTA;
					String uName = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 9);
					String pswd = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 10);
					String Resno = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 11);
					String Coemail = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 12);
					String COMILEAGE1 = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 13);
					String COMVA = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 14);
					String RANumber_1 = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 15);
					String RANumber_2 = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 16);
					String MilageIn2 = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 17);
					String MilageIn3 = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 18);
					String Action_code_CI = rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 19);
					...
					String strCOLNFNGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 20, strCOLNFNGetText);
					...
					String strCOVehicleModelGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 21, strCOVehicleModelGetText);
					...
					String strCOResNoGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 22, strCOResNoGetText);
					...
					String strCOMVAGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 23, strCOMVAGetText);
					...
					String strCORANoGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 24, strCORANoGetText);
					//rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 16, strCORANoGetText);
					...
					String strCOLicensePlateNoGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 25, strCOLicensePlateNoGetText);
					...
					String strCOEstimatedCostGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 26, strCOEstimatedCostGetText);
					...
					String strCOSystemMsgGetText = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 27, strCOSystemMsgGetText);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 28, strCOLNFNGetText1);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 29, strCOVehicleModelGetText1);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 31, strCOMVAGetText1);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 32, strCORANoGetText1);
					//rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 16, strCORANoGetText);
					...
					String strCOLicensePlateNoGetText1 = driver.findElement(By.xpath(
							...
							.getText();
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 33, strCOLicensePlateNoGetText1);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 34, strCOEstimatedCostGetText1);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 35, strCOSystemMsgGetText1);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 36, strCOLNFNGetText2);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 37, strCOVehicleModelGetText2);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 38, strCORANoGetText2);
					//rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 16, strCORANoGetText);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 39, strCOLicensePlateNoGetText2);
					...
					Thread.sleep(7000);
					rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 40, strCOSystemMsgGetText2);
					...
					// taking screenshot
					String ScreenShotPath = "C:\\Users\\cmn\\Desktop\\Selenium\\Screenshots\\BUDGET_GUI_Extended_Rentals\\";
					...
					if (rwe.getCellData("BUDGET_GUI_Extended_Rentals", k, 38).isEmpty()) {

						rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 41, "FAIL");
						test.log(Status.FAIL, "Fail");
					} else {
						rwe.setCellData("BUDGET_GUI_Extended_Rentals", k, 41, "PASS");
