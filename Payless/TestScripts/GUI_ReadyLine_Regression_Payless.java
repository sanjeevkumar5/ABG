/**
'#############################################################################################################################
'## SCRIPT NAME:                           GUI_ReadyLine_Regression_Payless
'## BRAND:                                 Payless
...
public class GUI_ReadyLine_Regression_Payless
{
   ...
   {   
	  ...
	  ReadWriteExcel rwe  = new ReadWriteExcel("C:\\GUI_Automation\\TestData\\Payless_GUITestData_ReadyLine_Regression.xlsx");
...
/*		    if (Execute.equals("Y"))
	     ...
	     if (Execute.equals("Y"))
	     {
			...
			if (!Temp.equalsIgnoreCase(outSTA))
		    {
               ...
               GUI_ReadyLine_Regression_Payless Payless = new GUI_ReadyLine_Regression_Payless();
               
               Payless.clickLogout(driver);
               Thread.sleep(1000);
               driver.close();
               driver.quit();
		    }
