...
public class Payless_Walkup_Rentals {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int k = 1; k<= 8; k++) 
		{
			ReadWriteExcel rw = new ReadWriteExcel("C:\\Downloads\\Selenium\\AVIS\\TestData\\Payless_GUITestData_WalkUp.xlsx");
			String TestExecute = rw.getCellData("Payless_GUI", k ,2);
		
			if (TestExecute.equals("Y"))
			{	
			String Testcasename   =rw.getCellData("Payless_GUI", k, 4);
			String TestUrl        = rw.getCellData("Payless_GUI", k, 7);
			String TestStn        = rw.getCellData("Payless_GUI", k, 8);
			String Testqauser     = rw.getCellData("Payless_GUI", k, 9);
			String Testqapwd      = rw.getCellData("Payless_GUI", k, 10);
			String LastName       = rw.getCellData("Payless_GUI", k, 11);
			String FirstName      = rw.getCellData("Payless_GUI", k, 12);
			String CheckOutDate   = rw.getCellData("Payless_GUI", k, 13);
			String CheckOutTime   = rw.getCellData("Payless_GUI", k, 14);
			String InStation      = rw.getCellData("Payless_GUI", k, 15);
			String CheckInDate    = rw.getCellData("Payless_GUI", k, 16);
			String CheckInTime    = rw.getCellData("Payless_GUI", k, 17);
			String CarGroup       = rw.getCellData("Payless_GUI", k, 18);
			String Awd            = rw.getCellData("Payless_GUI", k, 19);
			String CreditDeb_Card = rw.getCellData("Payless_GUI", k, 20);
			String CardNumber     = rw.getCellData("Payless_GUI", k, 21);
			String Month          = rw.getCellData("Payless_GUI", k, 22);
			String Year           = rw.getCellData("Payless_GUI", k, 23);
			String Reason         = rw.getCellData("Payless_GUI", k, 24);
			String Insurance      = rw.getCellData("Payless_GUI", k, 25);
			String Counterproduct = rw.getCellData("Payless_GUI", k, 26);
		...
		JavascriptExecutor js = (JavascriptExecutor) driver;  
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 29, strCOLNFNGetText);
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 28, strCOVehicleModelGetText);
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 27, strCOResNoGetText);
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 30, strCOResNoGetText);
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 31, strCORANoGetText);
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 32, strCOLicensePlateNoGetText);
           ...
           Thread.sleep(7000);
           rw.setCellData("Payless_GUI", k, 33, strCOEstimatedCostGetText);
