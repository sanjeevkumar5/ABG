...
/**
* '#############################################################################################################################
* '## SCRIPT NAME: GUI_Modify_Reservation_AVIS 
* '## BRAND: AVIS 
...
public class GUI_Modify_Reservation_AVIS {
	...
	public void test() throws Exception {
		...
		for (int k = 1; k <= 20; k++)
		{
			GUI_Modify_Reservation_AVIS avis = new GUI_Modify_Reservation_AVIS();
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\Users\\cmn\\Desktop\\Selenium\\TestData\\AVIS_GUITestData_ModifyReservation.xlsx");
			...
			if (Execute.equals("Y"))
			{
				...
				String lstname     = rwe.getCellData("Avis_GUI", k, 11);
				String fstname     = rwe.getCellData("Avis_GUI", k, 12);
				String comonth		= rwe.getCellData("Avis_GUI", k, 13);	
				String codte       = rwe.getCellData("Avis_GUI", k, 14);
				String cotme       = rwe.getCellData("Avis_GUI", k, 15);
				String insta       = rwe.getCellData("Avis_GUI", k, 16);
				String cimonth =	rwe.getCellData("Avis_GUI", k, 17);
				String cidte       = rwe.getCellData("Avis_GUI", k, 18);
				String citme       = rwe.getCellData("Avis_GUI", k, 19);
				String carGrp      = rwe.getCellData("Avis_GUI", k, 20);
				String awd         = rwe.getCellData("Avis_GUI", k, 21);
				...
				String reason  = rwe.getCellData("Avis_GUI", k, 26);
				String Ftncode      = rwe.getCellData("Avis_GUI", k, 27);
				String Ftnno      = rwe.getCellData("Avis_GUI", k, 28);
				String Reservation_No= rwe.getCellData("Avis_GUI", k, 29);
				String Modout = rwe.getCellData("Avis_GUI", k, 30);
				String Insurance = rwe.getCellData("Avis_GUI", k, 31);
				String Counterproducts = rwe.getCellData("Avis_GUI", k, 32);
				/* Open GUI URL's */
				...
				//functions.expandProtectionCoverageSection();
					...
					//if(Counterproducts.isEmpty()) {
						...
						String[] cpVal = rwe.getCellData("Avis_GUI", k, 32).split("-");
						for (String e : cpVal) {
				...
				//Modifying the Insurance
					...
					if (Insurance.isEmpty()) {
						...
						driver.findElement(By.xpath("//input[@value='Modify INS/CP']")).click();
						String[] insVal = rwe.getCellData("Avis_GUI", k, 31).split("-");
						for (String e : insVal) {
				...
				rwe.setCellData("Avis_GUI", k, 46, Modmsg); // write respopup in excel
				...
				rwe.setCellData("Avis_GUI", k, 46, Errormsg);
				Thread.sleep(2000);
				...
				//taking screenshot
				String ScreenShotPath = "C:\\Users\\cmn\\Desktop\\Selenium\\Screenshots\\Avis_GUI_Modify_Reservation";
				...
				if (rwe.getCellData("Avis_GUI", k, 33).isEmpty()) {
					rwe.setCellData("Avis_GUI", k, 47, "FAIL");
					test.log(Status.FAIL, "Fail");
				} else {
					rwe.setCellData("Avis_GUI", k, 47, "PASS");
