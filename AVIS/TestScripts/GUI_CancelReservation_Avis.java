...
* '#############################################################################################################################
**/
public class GUI_CancelReservation_Avis
{
	...
	public static void main(String[] args) throws Exception {
		...
		for (int k=1; k<=10;k++)
		{
			...
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\Selenium\\Test_Data\\AVIS\\AVIS_GUITestData_CancelReservation.xlsx");
			...
			if (Execute.equals("Y"))
			{
				...
				// functions.link(tokenURL,thinClient);
				 ...
				 driver.findElement(By.xpath("//input[@id='menulist:rateshopContainer:searchResForm:searchString']")).sendKeys(ResNo);
	...
	/* Capture Screenshot*/
					String ScreenShotPath = "C:\\Selenium\\Screenshots\\AVIS\\Avis_Cancel_Reservation\\";
					...
					try
					{
					   if (driver.findElement(By.xpath("//form[@id='templateInfoForm']")).isDisplayed())
					   {
						   ...
						   rwe.setCellData("Avis_GUI", k, 14, message);
                    ...
                    if(rwe.getCellData("Avis_GUI", k, 12).isEmpty())  {
						...
						rwe.setCellData("Avis_GUI", k, 15, "FAIL");
					} else {
						rwe.setCellData("Avis_GUI", k, 15, "PASS");
					}
