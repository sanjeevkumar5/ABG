...
public class GUI_CreateReservation_Avis
{
	...
	public static void main(String[] args) throws IOException, Exception, FileNotFoundException {
		...
		for (int k = 1; k <= 25; k++)
		{
			...
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\GUI_Automation\\Selenium\\GUI_TestDataSheets\\AVIS_GUITestData_CreateReservation.xlsx");
			String Execute = rwe.getCellData("Avis_GUI", k, 2);
			...
			if (Execute.equals("Y"))
			{
				...
				driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
				System.out.println(" iteration " + k);
				String FTN         = rwe.getCellData("Avis_GUI", k, 6);
				...
				String cidte       = rwe.getCellData("Avis_GUI", k, 16);
				String citme       = rwe.getCellData("Avis_GUI", k, 17);
				String carGrp      = rwe.getCellData("Avis_GUI", k, 18);
				String awd         = rwe.getCellData("Avis_GUI", k, 19);
				String cardname    = rwe.getCellData("Avis_GUI", k, 20);
				String cardNumber  = rwe.getCellData("Avis_GUI", k, 21);
				String expireMonth = rwe.getCellData("Avis_GUI", k, 22);
				String expireYear  = rwe.getCellData("Avis_GUI", k, 23);
				String reason      = rwe.getCellData("Avis_GUI", k, 24);
				...
				/* Enter Customer Informations */
				/*Enter FTN*/
				if (rwe.getCellData("Avis_GUI", k, 6).isEmpty())
				{
					System.out.println("No FTN added");
				}
				else
				...
				Thread.sleep(1000);
				driver.findElement(By.xpath("//*[@id='templateInfoForm:templateInfoButton']")).click(); // clicks OK button in Reservation popup
				...
				{ 
					System.out.print(" No Base Rates are Available ");
					//String RateShopErrorMsg = driver.findElement(By.xpath("//*[@id='resRateLookupDlg:rateLookupForm:counterRates_data']/tr[2]/td")).getText();
					String RateShopErrorMsg = driver.findElement(By.xpath("//*[@id='resRateLookupDlg:rateLookupForm:counterRates_data']")).getText();
					//*[@id="resRateLookupDlg:rateLookupForm:counterRates_data"]/tr[2]/td[2]/span
					String[] RateShopErrorMsg1 = RateShopErrorMsg.split("Base Rate");
//					for (String e:RateShopErrorMsg1)
//					{
//						System.out.print(e);
//					}
     				String RSerrmsg = RateShopErrorMsg1[1];
...
>>>>>>> branch 'master' of https://github.com/sanjeevkumar5/ABG.git
